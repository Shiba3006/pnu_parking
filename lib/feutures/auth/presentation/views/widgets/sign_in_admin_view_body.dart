...
class SignInAdminViewBody extends StatefulWidget {
  const SignInAdminViewBody({super.key});

  @override
  State<SignInAdminViewBody> createState() => _SignInViewBodyState();
}

class _SignInViewBodyState extends State<SignInAdminViewBody> {
              ...
              CustomButton(
                ...
                onPressed: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    BlocProvider.of<SignInCubit>(context).signInAdmin(
